...
public class LogginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private String Nombre, Correo, Photourl;
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount signInAccount) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()) {
                    Toast.makeText(getApplicationContext(),"no autetifico firebase", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void goMainScreen() {
        Intent intent = new Intent(this,OriDesActivity.class);
